...
def print_results(results_dic, results_stats_dic, model, 
    ...
    ## to print number of not a dog
    print("{:20}: {:5.1f}".format('N Not-Dog Images', results_stats_dic['n_notdogs_img']))
    print('       ')
    
    
    for NOTDOG1, NOTDOG2 in results_stats_dic.items():
            if NOTDOG1[0] == 'p':
                 print("{}: {}".format(NOTDOG1, NOTDOG2))
